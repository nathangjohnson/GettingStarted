...
${OBJECTDIR}/code/Line.o: code/Line.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Icode -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Line.o code/Line.cpp

${OBJECTDIR}/code/Logger.o: code/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -Icode -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Logger.o code/Logger.cpp

${OBJECTDIR}/code/Shape.o: code/Shape.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -Icode -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Shape.o code/Shape.cpp

${OBJECTDIR}/code/Triangle.o: code/Triangle.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -Icode -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Triangle.o code/Triangle.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Icode -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
